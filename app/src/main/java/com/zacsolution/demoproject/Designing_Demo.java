...
public class Designing_Demo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_designing__demo);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new men(), "COLORED");
        adapter.addFragment(new women(), "PRESCRIPTION");
        adapter.addFragment(new Contactus(), "ACCESSORIES");
